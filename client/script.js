...
function changeColor(event){
    sayHelloButton.backgroundColor = "black";
...
function changeColorTwo(event){
    sayHelloButton.backgroundColor = "#EFEFEF";
    sayHelloButton.style.color = "black";
    console.log("function activated");
}
 sayHelloButton.addEventListener("mouseout",changeColorTwo);
...
// CODE HERE
const queryRequest =() =>{
        axios.get('http://localhost:3000/query-test?Animal=Dog')
        .then(res => {
            console.log(res.data);
        })
        .catch(err =>{
